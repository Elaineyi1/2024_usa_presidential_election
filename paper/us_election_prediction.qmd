...
#| warning: false
#| label: fig-raw_grade
#| fig-cap: Distribution of Numeric Grades for Polls Before Cleaning
...
After eliminating polls conducted by pollsters with a numeric grade lower than 2, the distribution of numeric grades is shown in @fig-numeric_grade. The median grade is now about 2.75, with most polls having a grade higher than 2.5. Examples of pollsters with a 3.0 grade include The New York Times/Siena College, ABC News/The Washington Post, and YouGov. Examples with a 2.5 grade are the Public Policy Institute of California, Pew Research Center, and the University of Illinois Springfield Survey Research Office [@538PollsterRatings].
...
#| fig-cap: Distribution of Numeric Grades for State and National Surveys After Cleaning
poll_cleaned |> 
...
@fig-sample_size presents the frequency distribution of sample sizes. There are significantly more state surveys in total than national surveys. Most national surveys have sample sizes smaller than 2,500, while most state surveys have sizes smaller than 2,000. A few national surveys have larger sample sizes, as indicated by small red bumps around 7,500 and 20,000.
```{r}
#| message: false
#| echo: false
#| warning: false
