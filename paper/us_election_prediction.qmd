...
#| fig-cap: Timeline of average support ratios for Harris and Trump from polls that ended within the last 60 days, with Harris generally having slightly higher support
...
modelplot(harris_model, conf_level = 0.95, color = 'royalblue3') +
  labs(x = "Coefficients of Harris Support and 95% Confidence Intervals") +
  theme(
